...
/*
func (s *PostsTestSuite) TestCreatorIdHandler_POST_No_Params() {
...
func (s *PostsTestSuite) TestCreatorIdHandler_POST_Invalid_Body() {
	s.Tb = handlers.TestTable{
...
func (s *PostsTestSuite) TestCreatorIdHandler_POST_DB_Error() {
	s.Tb = handlers.TestTable{
		Name:              "Invalid request body",
		Data:              int64(1),
		ExpectedMockTimes: 1,
...
func (s *PostsTestSuite) TestCreatorIdHandler_POST_Create_Err() {
	s.Tb = handlers.TestTable{
...
func (s *PostsTestSuite) TestCreatorIdHandler_POST_Correct() {
	userId := int64(1)
...
func (s *PostsTestSuite) TestPostsHandler_GET_Correct() {
	userID := int64(1)
	s.Tb = handlers.TestTable{
		Name:              "correct",
...
func (s *PostsTestSuite) TestPostsHandler_GET_EmptyCreators() {
	s.Tb = handlers.TestTable{
