...
func (s *AwardsIdTestSuite) TestCreatorIdHandler_POST_Create_Err() {
	s.Tb = handlers.TestTable{
...
func (s *AwardsIdTestSuite) TestCreatorIdHandler_POST_Correct() {
	userId := int64(1)
...
func (s *AwardsIdTestSuite) TestAwardsHandler_GET_Correct() {
	userID := int64(1)
	s.Tb = handlers.TestTable{
		Name:              "correct",
...
func (s *AwardsIdTestSuite) TestAwardsHandler_GET_EmptyCreators() {
	s.Tb = handlers.TestTable{
...
func TestAwardsHandler(t *testing.T) {
	suite.Run(t, new(AwardsIdTestSuite))
}
*/
