...
type AttachesTestSuite struct {
	handlers.SuiteHandler
	handler *AttachesHandler
}
...
func (s *PostsIdTestSuite) TestCreatorIdHandler_POST_Invalid_Body() {
	s.Tb = handlers.TestTable{
...
func (s *PostsIdTestSuite) TestCreatorIdHandler_POST_DB_Error() {
	s.Tb = handlers.TestTable{
		Name:              "Invalid request body",
		Data:              int64(1),
		ExpectedMockTimes: 1,
...
func (s *PostsIdTestSuite) TestCreatorIdHandler_POST_Create_Err() {
	s.Tb = handlers.TestTable{
...
func (s *PostsIdTestSuite) TestCreatorIdHandler_POST_Correct() {
	userId := int64(1)
...
func (s *PostsIdTestSuite) TestAwardsHandler_GET_Correct() {
	userID := int64(1)
	s.Tb = handlers.TestTable{
		Name:              "correct",
...
func (s *PostsIdTestSuite) TestAwardsHandler_GET_EmptyCreators() {
	s.Tb = handlers.TestTable{
...
func TestAwardsHandler(t *testing.T) {
	suite.Run(t, new(PostsIdTestSuite))
}
*/
