...
type GlideGottenHandler struct {
	sessionClient       session_client.AuthCheckerClient
	glideMessageUsecase ucGlideMessage.Usecase
	bh.BaseHandler
}

func NewGlideGottenHandler(log *logrus.Logger,
	sManager session_client.AuthCheckerClient, ucGlideMessage ucGlideMessage.Usecase) *GlideGottenHandler {
	h := &GlideGottenHandler{
...
func (h *GlideGottenHandler) GET(w http.ResponseWriter, r *http.Request) {
	...
	u, err := h.glideMessageUsecase.GetGotten(userID.(string))
	if err != nil {
