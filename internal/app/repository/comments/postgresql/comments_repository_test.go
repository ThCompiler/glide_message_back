...
type SuiteCommentsRepository struct {
	models.Suite
...
func (s *SuiteCommentsRepository) checkUniqError(name string, creatorId int64,
...
func (s *SuiteCommentsRepository) setLevelCorrect(awardsId int64, creatorId int64, price int64) {
...
func (s *SuiteCommentsRepository) setLevelError(awardsId int64, creatorId int64, price int64, err error) {
	s.Mock.ExpectExec(regexp.QuoteMeta(setLevelQueryInsertParent)).
		WithArgs(awardsId, price, creatorId).
		WillReturnError(err)
}

func (s *SuiteCommentsRepository) deleteLevelCorrect(awardsId int64) {
	s.Mock.ExpectExec(regexp.QuoteMeta(deleteLevelQuery)).
		WithArgs(awardsId).
		WillReturnResult(driver.RowsAffected(1))
}

func (s *SuiteCommentsRepository) deleteLevelError(awardsId int64, err error) {
	s.Mock.ExpectExec(regexp.QuoteMeta(deleteLevelQuery)).
		WithArgs(awardsId).
		WillReturnError(err)
}

func (s *SuiteCommentsRepository) TestAwardsRepository_checkUniqName() {
	name := "sda"
	creatorId := int64(1)
...
func (s *SuiteCommentsRepository) TestAwardsRepository_setLevel() {
	creatorId := int64(1)
	awardsId := int64(1)
	price := int64(3)
...
func (s *SuiteCommentsRepository) TestAwardsRepository_deleteLevel() {
	awardsId := int64(1)
...
func (s *SuiteCommentsRepository) TestAwardsRepository_Create() {
	name := "sda"
	creatorId := int64(1)
	Id := int64(1)
...
func (s *SuiteCommentsRepository) TestAwardsRepository_Update() {
	name := "sda"
	creatorId := int64(1)
	Id := int64(1)
...
func (s *SuiteCommentsRepository) TestAwardsRepository_CheckAwards() {
	awardsId := int64(1)
...
func (s *SuiteCommentsRepository) TestAwardsRepository_UpdateCover() {
	awardsId := int64(1)
	cover := "sad"
	s.Mock.ExpectQuery(regexp.QuoteMeta(queryGetCreatorId)).
		WithArgs(awardsId).
...
func (s *SuiteCommentsRepository) TestAwardsRepository_FindByName() {
	creatorId := int64(1)
	name := "sad"
...
func (s *SuiteCommentsRepository) TestAwardsRepository_GetAwards() {
	creatorId := int64(1)
	Id := int64(1)
	name := "sad"
...
func (s *SuiteCommentsRepository) TestAwardsRepository_GetById() {
	creatorId := int64(1)
	Id := int64(2)
	name := "sad"
...
func (s *SuiteCommentsRepository) TestAwardsRepository_Delete() {
	awardsId := int64(1)
...
func TestAwardsRepository(t *testing.T) {
	suite.Run(t, new(SuiteCommentsRepository))
}
